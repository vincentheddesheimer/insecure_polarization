...
#figure_path <- "output_09_17/trust/figures/"
#dataframes_path <- "output_09_17/trust/datasets/"
figure_path <- "polarization/output/trust/figures/"
dataframes_path <- "polarization/output/trust/datasets/"
